...
class ItineraryCustom extends StatefulWidget {
  final String placeId;
  final String placeTitle;
  final String placeDescription;

  const ItineraryCustom({
    super.key,
  ...
  @override
  State<ItineraryCustom> createState() => _ItineraryCustomState();
}

class _ItineraryCustomState extends State<ItineraryCustom> {
